...
class _CustomCalendarScrollViewState extends State<CustomCalendarScrollView> with TickerProviderStateMixin {
  ...
  void didUpdateWidget(CustomCalendarScrollView oldWidget) {
    ...
    if (oldWidget.calendar.timeSlotViewSettings != widget.calendar.timeSlotViewSettings ||
      ...
      if (widget.view != CalendarView.month &&
          (oldWidget.calendar.timeSlotViewSettings.timeInterval != widget.calendar.timeSlotViewSettings.timeInterval ||
              (!isTimelineView &&
                  oldWidget.calendar.timeSlotViewSettings.timeIntervalHeight != widget.calendar.timeSlotViewSettings.timeIntervalHeight) ||
              (isTimelineView &&
                  oldWidget.calendar.timeSlotViewSettings.timeIntervalWidth != widget.calendar.timeSlotViewSettings.timeIntervalWidth))) {
    ...
    if ((widget.view == CalendarView.month &&
            widget.calendar.monthViewSettings.numberOfWeeksInView != oldWidget.calendar.monthViewSettings.numberOfWeeksInView) ||
  ...
  Widget build(BuildContext context) {
    ...
    final bool isHorizontalNavigation =
        widget.calendar.monthViewSettings.navigationDirection == MonthNavigationDirection.horizontal || widget.view != CalendarView.month;
    ...
    final bool isDayView = CalendarViewHelper.isDayView(widget.view, widget.calendar.timeSlotViewSettings.numberOfDaysInView,
        widget.calendar.timeSlotViewSettings.nonWorkingDays, widget.calendar.monthViewSettings.numberOfWeeksInView);
    final bool isTimelineView = CalendarViewHelper.isTimelineView(widget.view);
    ...
    final double resourceItemHeight = isResourceEnabled
        ? CalendarViewHelper.getResourceItemHeight(widget.calendar.resourceViewSettings.size, widget.height - viewHeaderHeight - timeLabelWidth,
            widget.calendar.resourceViewSettings, widget.calendar.dataSource!.resources!.length)
        : 0;
    ...
    final double weekNumberPanelWidth =
        CalendarViewHelper.getWeekNumberPanelWidth(widget.calendar.showWeekNumber, widget.width, widget.isMobilePlatform);
    ...
    final Widget customScrollWidget = GestureDetector(
      ...
      onHorizontalDragUpdate: isTimelineView
          ...
          : (DragUpdateDetails dragUpdateDetails) {
              _onHorizontalUpdate(dragUpdateDetails, isResourceEnabled, isMonthView, isTimelineView, viewHeaderHeight, timeLabelWidth,
                  resourceItemHeight, weekNumberPanelWidth, isNeedDragAndDrop);
            },
      onHorizontalDragEnd: isTimelineView
          ? null
          : (DragEndDetails dragEndDetails) {
              _onHorizontalEnd(dragEndDetails, isResourceEnabled, isTimelineView, isMonthView, viewHeaderHeight, timeLabelWidth, weekNumberPanelWidth,
                  isNeedDragAndDrop);
            },
      ...
      onVerticalDragUpdate: isHorizontalNavigation
          ? null
          : (DragUpdateDetails dragUpdateDetails) {
              _onVerticalUpdate(dragUpdateDetails, isResourceEnabled, isMonthView, isTimelineView, viewHeaderHeight, timeLabelWidth,
                  resourceItemHeight, weekNumberPanelWidth, isNeedDragAndDrop);
            },
      onVerticalDragEnd: isHorizontalNavigation
          ? null
          : (DragEndDetails dragEndDetails) {
              _onVerticalEnd(dragEndDetails, isResourceEnabled, isTimelineView, isMonthView, viewHeaderHeight, timeLabelWidth, weekNumberPanelWidth,
                  isNeedDragAndDrop);
            },
      child: CustomScrollViewerLayout(
          _addViews(), isHorizontalNavigation ? CustomScrollDirection.horizontal : CustomScrollDirection.vertical, _position, _currentChildIndex),
    );
    ...
    return GestureDetector(
      ...
      onLongPressMoveUpdate: isNeedDragAndDrop
          ? (LongPressMoveUpdateDetails details) {
              _handleLongPressMove(details.localPosition, isTimelineView, isResourceEnabled, isMonthView, viewHeaderHeight, timeLabelWidth,
                  resourceItemHeight, weekNumberPanelWidth);
            }
          : null,
      onLongPressEnd: isNeedDragAndDrop
          ? (LongPressEndDetails details) {
              _handleLongPressEnd(
                  details.localPosition, isTimelineView, isResourceEnabled, isMonthView, viewHeaderHeight, timeLabelWidth, weekNumberPanelWidth);
            }
          : null,
      child: Stack(
        children: <Widget>[
                            ...
                            HorizontalDragGestureRecognizer: GestureRecognizerFactoryWithHandlers<HorizontalDragGestureRecognizer>(
                              ...
                              (HorizontalDragGestureRecognizer instance) {
                                instance.onUpdate = (DragUpdateDetails details) {
                                  _handleDragUpdate(details, isTimelineView, isResourceEnabled, isMonthView, viewHeaderHeight, timeLabelWidth,
                                      resourceItemHeight, weekNumberPanelWidth, isNeedDragAndDrop, resourceViewSize);
                                };
                                instance.onStart = (DragStartDetails details) {
                                  _handleDragStart(details, isNeedDragAndDrop, isTimelineView, isResourceEnabled, viewHeaderHeight, timeLabelWidth,
                                      resourceViewSize);
                                };
                                instance.onEnd = (DragEndDetails details) {
                                  _handleDragEnd(details, isTimelineView, isResourceEnabled, isMonthView, viewHeaderHeight, timeLabelWidth,
  ...
  void _handleAppointmentDragStart(
      AppointmentView appointmentView, bool isTimelineView, Offset details, bool isResourceEnabled, double viewHeaderHeight, double timeLabelWidth) {
    ...
    _dragDetails.value.timeIntervalHeight = currentState._getTimeIntervalHeight(
        widget.calendar, widget.view, widget.width, widget.height, currentState.widget.visibleDates.length, widget.isMobilePlatform);
    _dragDetails.value.appointmentView = appointmentView;
    _dragDifferenceOffset = null;
    final Offset appointmentPosition =
        Offset(widget.isRTL ? appointmentView.appointmentRect!.right : appointmentView.appointmentRect!.left, appointmentView.appointmentRect!.top);
    double xPosition;
    double yPosition;
    if (isTimelineView) {
      ...
      if (widget.isRTL) {
        ...
        xPosition = xPosition -
            ((currentState._scrollController!.position.viewportDimension + currentState._scrollController!.position.maxScrollExtent) -
  ...
  void _handleLongPressStart(LongPressStartDetails details, bool isNeedDragAndDrop, bool isTimelineView, bool isResourceEnabled,
      double viewHeaderHeight, double timeLabelWidth) {
    final _CalendarViewState currentState = _getCurrentViewByVisibleDates()!;
  ...
  void _handleLongPressMove(Offset details, bool isTimelineView, bool isResourceEnabled, bool isMonthView, double viewHeaderHeight,
      double timeLabelWidth, double resourceItemHeight, double weekNumberPanelWidth) {
    ...
    final double timeIntervalHeight = currentState._getTimeIntervalHeight(
        widget.calendar, widget.view, widget.width, widget.height, currentState.widget.visibleDates.length, widget.isMobilePlatform);
    if (isTimelineView) {
      _updateAutoScrollDragTimelineView(currentState, appointmentPosition, viewHeaderHeight, timeIntervalHeight, resourceItemHeight,
          isResourceEnabled, details, isMonthView, allDayHeight, isTimelineView, timeLabelWidth, weekNumberPanelWidth);
    } else {
      _updateNavigationDayView(currentState, appointmentPosition, viewHeaderHeight, allDayHeight, timeIntervalHeight, timeLabelWidth,
          isResourceEnabled, isTimelineView, isMonthView, details, weekNumberPanelWidth);
    }
        ...
        if (_dragDetails.value.position.value != null &&
          ...
          Future<void> updateScrollPosition() async {
            ...
            if (_dragDetails.value.position.value != null &&
              ...
              _timer!.cancel();
              _timer = null;
              _updateAutoViewNavigationTimelineView(currentState, appointmentPosition, viewHeaderHeight, timeIntervalHeight, resourceItemHeight,
                  isResourceEnabled, details, isMonthView, allDayHeight, isTimelineView, timeLabelWidth, weekNumberPanelWidth, rtlValue);
            }
          }
  ...
  void _updateAppointmentDragUpdateCallback(
    ...
    final double overAllWidth = isTimelineView
        ? currentState._timeIntervalHeight * (currentState._horizontalLinesCount! * currentState.widget.visibleDates.length)
        : widget.width;
    final double overAllHeight =
        isTimelineView || isMonthView ? widget.height : currentState._timeIntervalHeight * currentState._horizontalLinesCount!;
    ...
    if (!isMonthView) {
      if (isTimelineView) {
        final DateTime time =
            _timeFromPosition(draggingTime, widget.calendar.timeSlotViewSettings, xPosition, currentState, timeIntervalHeight, isTimelineView)!;
        ...
        if (yPosition < 0) {
          ...
          draggingTime =
              _timeFromPosition(draggingTime, widget.calendar.timeSlotViewSettings, yPosition, currentState, timeIntervalHeight, isTimelineView)!;
        }
      }
    }
    ...
    if (isResourceEnabled) {
      targetResourceIndex = currentState._getSelectedResourceIndex(
          appointmentPosition.dy + currentState._timelineViewVerticalScrollController!.offset, viewHeaderHeight, timeLabelWidth);
      ...
      sourceSelectedResourceIndex =
          currentState._getSelectedResourceIndex(_dragDetails.value.appointmentView!.appointmentRect!.top, viewHeaderHeight, timeLabelWidth);
    ...
    final Duration appointmentDuration =
        _dragDetails.value.appointmentView!.appointment!.isAllDay && widget.view != CalendarView.month && !isTimelineView
    ...
    if (widget.calendar.onDragUpdate != null) {
      widget.calendar.onDragUpdate!(AppointmentDragUpdateDetails(
          draggingAppointment, previousResource, selectedResource, appointmentPosition, _dragDetails.value.draggingTime));
    }
  }

  void _handleLongPressEnd(Offset details, bool isTimelineView, bool isResourceEnabled, bool isMonthView, double viewHeaderHeight,
      double timeLabelWidth, double weekNumberPanelWidth) {
    if (_dragDetails.value.appointmentView == null) {
      return;
    }
    ...
    if (!isMonthView) {
      if (isTimelineView) {
        final DateTime time =
            _timeFromPosition(dropTime!, widget.calendar.timeSlotViewSettings, xPosition, currentState, timeIntervalHeight, isTimelineView)!;
    ...
    if ((appointment.recurrenceRule != null && appointment.recurrenceRule!.isNotEmpty) || appointment.recurrenceId != null) {
      ...
      for (int i = 0; i < _updateCalendarStateDetails.appointments.length; i++) {
        ...
        if (calendarApp.recurrenceId != null && calendarApp.recurrenceId == parentAppointment.id) {
          recurrenceDates
              .add(AppointmentHelper.convertTimeToAppointmentTimeZone(calendarApp.startTime, calendarApp.startTimeZone, widget.calendar.timeZone));
        }
      }
      ...
      if (parentAppointment.recurrenceExceptionDates != null) {
        for (int i = 0; i < parentAppointment.recurrenceExceptionDates!.length; i++) {
          recurrenceDates.remove(
              AppointmentHelper.convertTimeToAppointmentTimeZone(parentAppointment.recurrenceExceptionDates![i], '', widget.calendar.timeZone));
        }
      }
  ...
  void _handleDragStart(DragStartDetails details, bool isNeedDragAndDrop, bool isTimelineView, bool isResourceEnabled, double viewHeaderHeight,
      double timeLabelWidth, double resourceViewSize) {
    if (!CalendarViewHelper.isTimelineView(widget.view)) {
      return;
    }
    ...
    if (viewKey._hoveringAppointmentView != null && !widget.isMobilePlatform && isNeedDragAndDrop) {
      _handleAppointmentDragStart(viewKey._hoveringAppointmentView!.clone(), isTimelineView,
          Offset(details.localPosition.dx - widget.width, details.localPosition.dy), isResourceEnabled, viewHeaderHeight, timeLabelWidth);
      return;
    }
  ...
  /// drag as null;
  void _handleDragUpdate(DragUpdateDetails details, bool isTimelineView, bool isResourceEnabled, bool isMonthView, double viewHeaderHeight,
      double timeLabelWidth, double resourceItemHeight, double weekNumberPanelWidth, bool isNeedDragAndDrop, double resourceViewSize) {
    if (!CalendarViewHelper.isTimelineView(widget.view)) {
      return;
    }
    final _CalendarViewState viewKey = _getCurrentViewByVisibleDates()!;
    ...
    if (_dragDetails.value.appointmentView != null && !widget.isMobilePlatform && isNeedDragAndDrop) {
      _handleLongPressMove(Offset(details.localPosition.dx - widget.width, details.localPosition.dy), isTimelineView, isResourceEnabled, isMonthView,
  ...
  void _handleDragEnd(DragEndDetails details, bool isTimelineView, bool isResourceEnabled, bool isMonthView, double viewHeaderHeight,
      double timeLabelWidth, double weekNumberPanelWidth, bool isNeedDragAndDrop) {
    if (_dragDetails.value.appointmentView != null && !widget.isMobilePlatform && isNeedDragAndDrop) {
      _handleLongPressEnd(_dragDetails.value.position.value! - _dragDifferenceOffset!, isTimelineView, isResourceEnabled, isMonthView,
  ...
  void _handlePointerSignal(PointerSignalEvent event) {
    ...
    if (event is PointerScrollEvent && viewKey != null) {
      ...
      final double targetScrollOffset = math.min(
          math.max(viewKey._scrollController!.position.pixels + scrolledPosition, viewKey._scrollController!.position.minScrollExtent),
  ...
  void _updateVisibleDates() {
    ...
    final int visibleDatesCount = DateTimeHelper.getViewDatesCount(
        widget.view, widget.calendar.monthViewSettings.numberOfWeeksInView, widget.calendar.timeSlotViewSettings.numberOfDaysInView, nonWorkingDays);

    final DateTime currentDate = DateTime(
        _updateCalendarStateDetails.currentDate!.year, _updateCalendarStateDetails.currentDate!.month, _updateCalendarStateDetails.currentDate!.day);
    final DateTime prevDate = DateTimeHelper.getPreviousViewStartDate(
        widget.view, widget.calendar.monthViewSettings.numberOfWeeksInView, currentDate, visibleDatesCount, nonWorkingDays);
    ...
    _previousViewVisibleDates =
        getVisibleDates(widget.isRTL ? nextDate : prevDate, nonWorkingDays, widget.calendar.firstDayOfWeek, visibleDatesCount).cast();
    _nextViewVisibleDates =
        getVisibleDates(widget.isRTL ? prevDate : nextDate, nonWorkingDays, widget.calendar.firstDayOfWeek, visibleDatesCount).cast();
  ...
  void _updateNextViewVisibleDates() {
    ...
    if (widget.isRTL) {
      currentViewDate = DateTimeHelper.getPreviousViewStartDate(
          widget.view, widget.calendar.monthViewSettings.numberOfWeeksInView, currentViewDate, visibleDatesCount, nonWorkingDays);
    } else {
  ...
  void getRecurrenceRegions(
      CalendarTimeRegion region, List<CalendarTimeRegion> regions, DateTime visibleStartDate, DateTime visibleEndDate, String? calendarTimeZone) {
  ...
  void _moveToNextViewWithAnimation() {
    ...
    if (!DateTimeHelper.canMoveToNextView(widget.view, widget.calendar.monthViewSettings.numberOfWeeksInView, widget.calendar.minDate,
  ...
  void _moveToPreviousViewWithAnimation({bool isScrollToEnd = false}) {
    ...
    if (!DateTimeHelper.canMoveToPreviousView(widget.view, widget.calendar.monthViewSettings.numberOfWeeksInView, widget.calendar.minDate,
        widget.calendar.maxDate, _currentViewVisibleDates, widget.calendar.timeSlotViewSettings.nonWorkingDays, widget.isRTL)) {
      return;
    }
  ...
  DateTime _updateSelectedDateForRightArrow(_CalendarView currentView, _CalendarViewState currentViewState, DateTime? selectedDate) {
    ...
    if (!CalendarViewHelper.isTimelineView(widget.view)) {
      ...
      if (widget.view == CalendarView.month &&
          !CalendarViewHelper.isCurrentMonthDate(widget.calendar.monthViewSettings.numberOfWeeksInView,
              widget.calendar.monthViewSettings.showTrailingAndLeadingDates, currentView.visibleDates[visibleDatesCount ~/ 2].month, selectedDate)) {
        _moveToNextViewWithAnimation();
      ...
      if ((rowIndex * singleChildWidth) + xPosition + currentViewState._timeIntervalHeight ==
          currentViewState._scrollController!.position.maxScrollExtent + currentViewState._scrollController!.position.viewportDimension) {
        _moveToNextViewWithAnimation();
        SchedulerBinding.instance.addPostFrameCallback((_) {
  ...
  DateTime? _updateSelectedDateForUpArrow(
      _CalendarView currentView, _CalendarViewState currentViewState, DateTime? selectedDate, DateTime? appointmentSelectedDate) {
    if (widget.view == CalendarView.month) {
      final int rowIndex = _getRowOfDate(currentView.visibleDates, selectedDate!);
      if (rowIndex == 0) {
        return selectedDate;
      ...
      selectedDate =
          AppointmentHelper.addDaysWithTime(selectedDate, -DateTime.daysPerWeek, selectedDate.hour, selectedDate.minute, selectedDate.second);
      ...
      final double resourceItemHeight = CalendarViewHelper.getResourceItemHeight(widget.calendar.resourceViewSettings.size, widget.height,
          widget.calendar.resourceViewSettings, widget.calendar.dataSource!.resources!.length);
  ...
  DateTime? _updateSelectedDateForDownArrow(
      _CalendarView currentView, _CalendarViewState currentViewState, DateTime? selectedDate, DateTime? selectedAppointmentDate) {
    if (widget.view == CalendarView.month) {
      final int rowIndex = _getRowOfDate(currentView.visibleDates, selectedDate!);
      ...
      if (currentViewState._scrollController!.offset + (widget.height - viewHeaderHeight) <
              currentViewState._scrollController!.position.viewportDimension + currentViewState._scrollController!.position.maxScrollExtent &&
      ...
      if (currentViewState._selectedResourceIndex * resourceItemHeight >=
        ...
        double scrollPosition = currentViewState._timelineViewVerticalScrollController!.offset + resourceItemHeight;
        scrollPosition = scrollPosition > currentViewState._timelineViewVerticalScrollController!.position.maxScrollExtent
  ...
  void _moveToSelectedTimeSlot() {
    ...
    currentViewState._scrollController!.jumpTo(currentViewState._scrollController!.position.maxScrollExtent > scrollPosition
        ? scrollPosition
        : currentViewState._scrollController!.position.maxScrollExtent);
  }

  DateTime? _updateSelectedDate(KeyEvent event, _CalendarViewState currentViewState, _CalendarView currentView, int resourceIndex,
      DateTime? selectedAppointmentDate, bool isAllDayAppointment) {
    ...
    if (event.logicalKey == LogicalKeyboardKey.arrowRight) {
        ...
        if (widget.controller.view != CalendarView.month && !CalendarViewHelper.isTimelineView(widget.calendar.view)) {
          ...
          if (yPosition < 1 && !_isSelectedDateEnabled(selectedDate, resourceIndex, true)) {
            yPosition = AppointmentHelper.timeToPosition(
                widget.calendar, currentViewState._selectionPainter!.selectedDate!, currentViewState._timeIntervalHeight);
      ...
      do {
        ...
        if (widget.controller.view != CalendarView.month && !CalendarViewHelper.isTimelineView(widget.calendar.view)) {
          ...
          _getRowOfDate(currentView.visibleDates, selectedDate) != widget.calendar.monthViewSettings.numberOfWeeksInView - 1);
      return selectedDate;
    }
  ...
  bool _isSelectedDateEnabled(DateTime date, int resourceIndex, [bool isMinMaxDate = false]) {
    ...
    if ((isMonthView && !isDateWithInDateRange(widget.calendar.minDate, widget.calendar.maxDate, date)) ||
        (!isMonthView && !CalendarViewHelper.isDateTimeWithInDateTimeRange(widget.calendar.minDate, widget.calendar.maxDate, date, timeInterval))) {
      return isMinMaxDate;
    }
    ...
    if (isMonthView && CalendarViewHelper.isDateInDateCollection(_getBlackoutDates(), date)) {
      ...
      for (int i = 0; i < regions.length; i++) {
        ...
        if (region.enablePointerInteraction ||
            (region.actualStartTime.isAfter(date) && !CalendarViewHelper.isSameTimeSlot(region.actualStartTime, date)) ||
  ...
  KeyEventResult _updatePageUpAndDown(KeyEvent event, _CalendarViewState currentViewState, bool isResourceEnabled) {
    ...
    final bool isDayView = CalendarViewHelper.isDayView(widget.controller.view!, widget.calendar.timeSlotViewSettings.numberOfDaysInView,
        widget.calendar.timeSlotViewSettings.nonWorkingDays, widget.calendar.monthViewSettings.numberOfWeeksInView);
    ...
    if (event.logicalKey == LogicalKeyboardKey.pageUp || (platform == TargetPlatform.windows && event.logicalKey.keyId == 0x10700000021)) {
      ...
      final double viewPortHeight =
          isResourceEnabled ? widget.height - viewHeaderHeight - timeRulerSize : widget.height - allDayHeight - viewHeaderHeight;
  ...
  KeyEventResult _updateAppointmentSelection(KeyEvent event, _CalendarViewState currentVisibleViewState, bool isResourceEnabled,
      AppointmentView? currentSelectedAppointment, AppointmentView? currentAllDayAppointment) {
    ...
    if (HardwareKeyboard.instance.isShiftPressed) {
      if (event.logicalKey == LogicalKeyboardKey.tab) {
          ...
          if (currentVisibleViewState._selectionPainter!.selectedDate != null && appointmentCollection.isNotEmpty) {
            for (int i = 0; i < appointmentCollection.length; i++) {
              if (AppointmentHelper.getDifference(
                      currentVisibleViewState._selectionPainter!.selectedDate!, appointmentCollection[i].appointment!.actualStartTime)
                  .isNegative) {
                continue;
              }
        ...
        return _updateAppointmentSelectionOnView(
            selectedAppointment, currentVisibleViewState, isAllDay, isResourceEnabled, !HardwareKeyboard.instance.isShiftPressed);
      }
  ...
  KeyEventResult _updateAppointmentSelectionOnView(
      AppointmentView? selectedAppointment, _CalendarViewState currentVisibleViewState, bool isAllDay, bool isResourceEnabled, bool isForward) {
    ...
    final DateTime visibleEndDate =
        AppointmentHelper.convertToEndTime(currentVisibleViewState.widget.visibleDates[currentVisibleViewState.widget.visibleDates.length - 1]);
    ...
    if (selectedAppointment != null &&
        AppointmentHelper.isAppointmentWithinVisibleDateRange(selectedAppointment.appointment!, visibleStartDate, visibleEndDate)) {
      ...
      if (widget.controller.view != CalendarView.month) {
        ...
        if (isResourceEnabled) {
          final double resourcePanelHeight =
              widget.resourcePanelScrollController!.position.viewportDimension + widget.resourcePanelScrollController!.position.maxScrollExtent;
          final double timeRulerSize =
                  CalendarViewHelper.getTimeLabelWidth(widget.calendar.timeSlotViewSettings.timeRulerSize, widget.controller.view!),
              viewPortSize = widget.height - viewHeaderHeight - timeRulerSize;
          _updateScrollViewToAppointment(
              selectedAppointment.appointmentRect!.top, widget.resourcePanelScrollController!, viewPortSize, resourcePanelHeight);
        }
  ...
  KeyEventResult _onKeyDown(FocusNode node, KeyEvent event) {
    ...
    if (event.logicalKey == LogicalKeyboardKey.enter && CalendarViewHelper.shouldRaiseCalendarTapCallback(widget.calendar.onTap)) {
      final AppointmentView? selectedAppointment =
          currentVisibleViewState._allDaySelectionNotifier.value?.appointmentView ?? currentVisibleViewState._selectionPainter!.appointmentView;
      final List<CalendarAppointment>? selectedAppointments = widget.controller.view == CalendarView.month && selectedAppointment == null
          ? AppointmentHelper.getSelectedDateAppointments(
              _updateCalendarStateDetails.appointments, widget.calendar.timeZone, _updateCalendarStateDetails.selectedDate)
      ...
      CalendarViewHelper.raiseCalendarTapCallback(
          widget.calendar,
          tappedElement == CalendarElement.appointment ? selectedAppointments![0].startTime : _updateCalendarStateDetails.selectedDate,
          CalendarViewHelper.getCustomAppointments(selectedAppointments, widget.calendar.dataSource),
          tappedElement,
          isResourcesEnabled ? widget.calendar.dataSource!.resources![currentVisibleViewState._selectedResourceIndex] : null);
    }
    ...
    if ((currentVisibleViewState._selectionPainter!.selectedDate != null &&
      ...
      final DateTime? selectedDate =
          _updateSelectedDate(event, currentVisibleViewState, currentVisibleView, resourceIndex, selectedAppointmentDate, isAllDayAppointment);
      ...
      if (widget.calendar.onSelectionChanged != null &&
        ...
        CalendarViewHelper.raiseCalendarSelectionChangedCallback(
            widget.calendar, selectedDate, isResourcesEnabled ? widget.resourceCollection![currentVisibleViewState._selectedResourceIndex] : null);
      }
  ...
  void _onHorizontalStart(DragStartDetails dragStartDetails, bool isResourceEnabled, bool isTimelineView, double viewHeaderHeight,
      double timeLabelWidth, bool isNeedDragAndDrop) {
    final _CalendarViewState currentState = _getCurrentViewByVisibleDates()!;
  ...
  void _onHorizontalUpdate(DragUpdateDetails dragUpdateDetails,
    ...
    if (_dragDetails.value.appointmentView != null && !widget.isMobilePlatform && isNeedDragAndDrop) {
      _handleLongPressMove(Offset(dragUpdateDetails.localPosition.dx - widget.width, dragUpdateDetails.localPosition.dy), isTimelineView,
    ...
    switch (widget.calendar.viewNavigationMode) {
      ...
      case ViewNavigationMode.snap:
        ...
        if (widget.calendar.monthViewSettings.navigationDirection == MonthNavigationDirection.horizontal || widget.view != CalendarView.month) {
          ...
          if (difference < 0 &&
              !DateTimeHelper.canMoveToNextView(widget.view, widget.calendar.monthViewSettings.numberOfWeeksInView, widget.calendar.minDate,
                  widget.calendar.maxDate, _currentViewVisibleDates, widget.calendar.timeSlotViewSettings.nonWorkingDays, widget.isRTL)) {
            _position = 0;
            return;
          } else if (difference > 0 &&
              !DateTimeHelper.canMoveToPreviousView(widget.view, widget.calendar.monthViewSettings.numberOfWeeksInView, widget.calendar.minDate,
                  widget.calendar.maxDate, _currentViewVisibleDates, widget.calendar.timeSlotViewSettings.nonWorkingDays, widget.isRTL)) {
            _position = 0;
            return;
          }
  ...
  void _onVerticalStart(DragStartDetails dragStartDetails, bool isResourceEnabled, bool isTimelineView, double viewHeaderHeight,
      double timeLabelWidth, bool isNeedDragAndDrop) {
    final _CalendarViewState currentState = _getCurrentViewByVisibleDates()!;
    if (currentState._hoveringAppointmentView != null &&
        currentState._hoveringAppointmentView!.appointment != null &&
  ...
  void _onVerticalUpdate(DragUpdateDetails dragUpdateDetails,
      ...
      bool isNeedDragAndDrop = false]) {
    if (_dragDetails.value.appointmentView != null && !widget.isMobilePlatform && isNeedDragAndDrop) {
      _handleLongPressMove(Offset(dragUpdateDetails.localPosition.dx, dragUpdateDetails.localPosition.dy - widget.height), isTimelineView,
          isResourceEnabled, isMonthView, viewHeaderHeight, timeLabelWidth, resourceItemHeight, weekNumberPanelWidth);
      return;
    }
    switch (widget.calendar.viewNavigationMode) {
      ...
      case ViewNavigationMode.snap:
        ...
        if (widget.calendar.monthViewSettings.navigationDirection == MonthNavigationDirection.vertical &&
          ...
          if (difference < 0 &&
              !DateTimeHelper.canMoveToNextView(widget.view, widget.calendar.monthViewSettings.numberOfWeeksInView, widget.calendar.minDate,
                  widget.calendar.maxDate, _currentViewVisibleDates, widget.calendar.timeSlotViewSettings.nonWorkingDays)) {
            _position = 0;
            return;
          } else if (difference > 0 &&
              !DateTimeHelper.canMoveToPreviousView(widget.view, widget.calendar.monthViewSettings.numberOfWeeksInView, widget.calendar.minDate,
...
class _CalendarViewState extends State<_CalendarView> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _timeIntervalHeight =
        _getTimeIntervalHeight(widget.calendar, widget.view, widget.width, widget.height, widget.visibleDates.length, widget.isMobilePlatform);
    if (widget.view != CalendarView.month) {
        ...
        children: <Widget>[
          GestureDetector(
            ...
            child: SizedBox(
                ...
                width: widget.width,
                child: _addDayView(widget.width, _timeIntervalHeight * _horizontalLinesCount!, _isRTL, widget.locale, isCurrentView)),
          ),
          _getResizeShadowView()
        ],
      ),
  ...
  void _updateAllDayHeight(bool isCurrentView) {
    ...
    if (isDayView) {
      ...
      _allDayHeight =
          _updateCalendarStateDetails.allDayPanelHeight > _kAllDayLayoutHeight ? _kAllDayLayoutHeight : _updateCalendarStateDetails.allDayPanelHeight;
  ...
  void _scrollToPosition() {
    SchedulerBinding.instance.addPostFrameCallback((_) {
      ...
      if (_scrollController != null) {
        _scrollController!
            .jumpTo(_scrollController!.position.maxScrollExtent > scrollPosition ? scrollPosition : _scrollController!.position.maxScrollExtent);
      }
    });
  }
    ...
    if (!CalendarViewHelper.isTimelineView(widget.view)) {
      ...
      for (int i = 0; i < visibleDatesCount; i++) {
        ...
        if (widget.view == CalendarView.timelineMonth) {
          ...
          timeToPosition =
              (_getSingleViewWidthForTimeLineView(this) * i) + AppointmentHelper.timeToPosition(widget.calendar, date, _timeIntervalHeight);
        }
  ...
  double _getPositionFromDate(DateTime date) {
    final int visibleDatesCount = widget.visibleDates.length;
    _timeIntervalHeight =
        _getTimeIntervalHeight(widget.calendar, widget.view, widget.width, widget.height, visibleDatesCount, widget.isMobilePlatform);
    double timeToPosition = 0;
    final bool isTimelineView = CalendarViewHelper.isTimelineView(widget.view);
    if (!isTimelineView) {
      timeToPosition = AppointmentHelper.timeToPosition(widget.calendar, date, _timeIntervalHeight);
    ...
    if (!isTimelineView) {
      ...
      final double scrollViewContentWidth =
          CalendarViewHelper.getHorizontalLinesCount(widget.calendar.timeSlotViewSettings, widget.view) * _timeIntervalHeight * visibleDatesCount;
  ...
  void _updateTimeSlotView(_CalendarView oldWidget) {
    ...
    if (!CalendarViewHelper.isDayView(widget.view, widget.calendar.timeSlotViewSettings.numberOfDaysInView,
            widget.calendar.timeSlotViewSettings.nonWorkingDays, widget.calendar.monthViewSettings.numberOfWeeksInView) &&
        _allDayHeight == 0) {
  ...
  void _onVerticalEnd(DragEndDetails details) {
    ...
    final double currentYPosition =
        _resizingDetails.value.position.value!.dy > widget.height - 1 ? widget.height - 1 : _resizingDetails.value.position.value!.dy;
    ...
    final DateTime resizingTime =
        _timeFromPosition(appointment.actualStartTime, widget.calendar.timeSlotViewSettings, yPosition, null, timeIntervalHeight, false)!;
    ...
    if (CalendarViewHelper.isDraggingAppointmentHasDisabledCell(widget.regions!, widget.blackoutDates!, updatedStartTime, updatedEndTime, false,
        false, widget.calendar.minDate, widget.calendar.maxDate, timeInterval, -1, widget.resourceCollection)) {
  ...
  void _onHorizontalStart(DragStartDetails details) {
    ...
    if (!isTimelineView && widget.view != CalendarView.month) {
      ...
      if (isResourceEnabled) {
        resource =
            widget.calendar.dataSource!.resources![_getSelectedResourceIndex(appointmentView.appointmentRect!.top, viewHeaderHeight, timeLabelWidth)];
      }
  ...
  void _onHorizontalUpdate(DragUpdateDetails details) {
    ...
    if (isTimelineView) {
      ...
      _updateAutoScrollTimeline(
          details, timeIntervalHeight, isForwardResize, isBackwardResize, xPosition, yPosition, timeLabelWidth, isResourceEnabled);
    } else if (widget.view == CalendarView.month) {
      final double viewHeaderHeight = CalendarViewHelper.getViewHeaderHeight(widget.calendar.viewHeaderHeight, widget.view);
      ...
      if (_isRTL) {
        if (isForwardResize &&
            ((appointmentRowIndex == resizingRowIndex && xPosition < _maximumResizingPosition!) || appointmentRowIndex < resizingRowIndex)) {
          xPosition = _maximumResizingPosition!;
      ...
      final int rowDifference = isBackwardResize
          ...
          : _isRTL
              ...
              : (appointmentRowIndex - resizingRowIndex).abs();
      if (((!_isRTL &&
                  ((isBackwardResize && appointmentRowIndex > resizingRowIndex) || (isForwardResize && appointmentRowIndex < resizingRowIndex))) ||
              (_isRTL &&
                  ((isBackwardResize && appointmentRowIndex < resizingRowIndex) || (isForwardResize && appointmentRowIndex > resizingRowIndex)))) &&
          resizingRowIndex != appointmentRowIndex &&
  ...
  void _onHorizontalEnd(DragEndDetails details) {
    ...
    if (_resizingDetails.value.isAllDayPanel || widget.view == CalendarView.month || widget.view == CalendarView.timelineMonth) {
      ...
      final DateTime time =
          _timeFromPosition(resizingTime, widget.calendar.timeSlotViewSettings, xPosition, this, timeIntervalHeight, isTimelineView)!;
    ...
    if (isResourceEnabled) {
      selectedResourceIndex =
          _getSelectedResourceIndex(_resizingDetails.value.appointmentView!.appointmentRect!.top, viewHeaderHeight, timeLabelWidth);
  ...
  Future<void> _updateAutoScrollDay(DragUpdateDetails details, double viewHeaderHeight, double allDayPanelHeight, bool isForwardResize,
      bool isBackwardResize, double? yPosition) async {
    if (_resizingDetails.value.appointmentView == null) {
      return;
    }
        ...
        if (yPosition != null && yPosition! <= viewHeaderHeight + allDayPanelHeight && _scrollController!.offset != 0) {
          Future<void> updateScrollPosition() async {
            ...
            _updateMaximumResizingPosition(
                isForwardResize, isBackwardResize, _resizingDetails.value.appointmentView!, allDayPanelHeight, viewHeaderHeight);
            if ((isForwardResize && yPosition! < _maximumResizingPosition!) || (isBackwardResize && yPosition! > _maximumResizingPosition!)) {
              yPosition = _maximumResizingPosition;
            }
            _updateAppointmentResizingUpdateCallback(isForwardResize, isBackwardResize, yPosition!, viewHeaderHeight, allDayPanelHeight);
  ...
  Future<void> _updateAutoScrollTimeline(DragUpdateDetails details, double timeIntervalHeight, bool isForwardResize, bool isBackwardResize,
      double? xPosition, double yPosition, double timeLabelWidth, bool isResourceEnabled) async {
    if (_resizingDetails.value.appointmentView == null) {
      return;
    }
  ...
  void _updateMaximumResizingPosition(
      bool isForwardResize, bool isBackwardResize, AppointmentView appointmentView, double? allDayPanelHeight, double? viewHeaderHeight) {
    switch (widget.view) {
      case CalendarView.schedule:
        break;
      case CalendarView.day:
          ...
          if (_resizingDetails.value.isAllDayPanel) {
            ...
            if (isForwardResize) {
              _maximumResizingPosition = appointmentView.appointmentRect!.left +
                  (appointmentView.appointmentRect!.width > minimumCellWidth ? minimumCellWidth : appointmentView.appointmentRect!.width);
            } else if (isBackwardResize) {
            ...
            if (isForwardResize) {
              _maximumResizingPosition = (appointmentView.appointmentRect!.top - _scrollController!.offset + allDayPanelHeight! + viewHeaderHeight!) +
      ...
      case CalendarView.timelineMonth:
        {
          ...
          if (isForwardResize) {
            ...
            if (_isRTL) {
              _maximumResizingPosition =
                  _scrollController!.offset - _scrollController!.position.maxScrollExtent + appointmentView.appointmentRect!.left;
            }
            ...
            if (_isRTL) {
              _maximumResizingPosition =
                  _scrollController!.offset - _scrollController!.position.maxScrollExtent + appointmentView.appointmentRect!.right;
            }
            _maximumResizingPosition = _maximumResizingPosition! -
                (appointmentView.appointmentRect!.width / 2 > minimumTimeIntervalSize
                    ? minimumTimeIntervalSize
  ...
  void _updateAppointmentResizingUpdateCallback(
      bool isForwardResize, bool isBackwardResize, double yPosition, double? viewHeaderHeight, double? allDayPanelHeight,
    ...
    if (CalendarViewHelper.isTimelineView(widget.view)) {
      ...
      final DateTime time = _timeFromPosition(resizingTime, widget.calendar.timeSlotViewSettings,
          xPosition! > widget.width - 1 ? widget.width - 1 : (xPosition < 0 ? 0 : xPosition), this, timeIntervalHeight, true)!;
      ...
      resizingTime = _timeFromPosition(_resizingDetails.value.appointmentView!.appointment!.actualStartTime, widget.calendar.timeSlotViewSettings,
          currentYPosition > 0 ? currentYPosition : 0, this, timeIntervalHeight, false)!;
    }
  ...
  Widget _addTimelineView(double width, double height, String locale) {
    ...
    if (isResourceEnabled) {
      ...
      resourceItemHeight = CalendarViewHelper.getResourceItemHeight(resourceViewSize, widget.height - viewHeaderHeight - timeLabelSize,
          widget.calendar.resourceViewSettings, widget.calendar.dataSource!.resources!.length);
    ...
    return Stack(children: <Widget>[
      ...
      Positioned(
          ...
          child: ListView(
            ...
            physics: widget.isMobilePlatform ? const _CustomNeverScrollableScrollPhysics() : const ClampingScrollPhysics(),
            children: <Widget>[
              RepaintBoundary(
                  child: CustomPaint(
                painter: _TimeRulerView(
  ...
  int _getSelectedResourceIndex(double yPosition, double viewHeaderHeight, double timeLabelSize) {
    final int resourceCount =
        widget.calendar.dataSource != null && widget.calendar.dataSource!.resources != null ? widget.calendar.dataSource!.resources!.length : 0;
  ...
  CalendarDetails? _getDetailsForTimeline(Offset position) {
    ...
    if (appointmentView == null) {
      ...
      return CalendarDetails(<dynamic>[CalendarViewHelper.getAppointmentDetail(appointmentView.appointment!, widget.calendar.dataSource)], getDate,
          CalendarElement.appointment, calendarResource);
    }
  }
  ...
  double _getTimeIntervalHeight(SfCalendar calendar, CalendarView view, double width, double height, int visibleDatesCount, bool isMobilePlatform) {
    ...
    switch (view) {
      ...
      case CalendarView.workWeek:
        timeIntervalHeight =
            (height - allDayViewHeight - viewHeaderHeight) / CalendarViewHelper.getHorizontalLinesCount(calendar.timeSlotViewSettings, view);
        break;
      case CalendarView.timelineDay:
      case CalendarView.timelineWeek:
      case CalendarView.timelineWorkWeek:
  ...
  DateTime? _getTappedViewHeaderDate(Offset localPosition, double width) {
    ...
    if (!CalendarViewHelper.isTimelineView(widget.view)) {
      ...
      index = ((_scrollController!.offset + (_isRTL ? _scrollController!.position.viewportDimension - localPosition.dx : localPosition.dx)) /
  ...
  void _updateHoveringForViewHeader(Offset localPosition, double xPosition, double yPosition, double viewHeaderHeight) {
    ...
    final DateTime? hoverDate =
        _getTappedViewHeaderDate(Offset(CalendarViewHelper.isTimelineView(widget.view) ? localPosition.dx : xPosition, yPosition), widget.width);
  ...
  void _updateMouseCursorForAppointment(AppointmentView? appointmentView, double xPosition, double yPosition, bool isTimelineViews,
    ...
    if (isAllDayPanel || (widget.view == CalendarView.month || isTimelineViews)) {
      ...
      if (xPosition >= appointmentView.appointmentRect!.left &&
          ...
          ((isMonthView &&
                  isSameDate(_isRTL ? appointmentEndTime : appointmentStartTime, _isRTL ? appointmentExactEndTime : appointmentExactStartTime)) ||
              (!isMonthView &&
                  CalendarViewHelper.isSameTimeSlot(
                      _isRTL ? appointmentEndTime : appointmentStartTime, _isRTL ? appointmentExactEndTime : appointmentExactStartTime))) &&
        ...
        setState(() {
          ...
          ((isMonthView &&
                  isSameDate(_isRTL ? appointmentStartTime : appointmentEndTime, _isRTL ? appointmentExactStartTime : appointmentExactEndTime)) ||
              (!isMonthView &&
                  CalendarViewHelper.isSameTimeSlot(
                      _isRTL ? appointmentStartTime : appointmentEndTime, _isRTL ? appointmentExactStartTime : appointmentExactEndTime))) &&
  ...
  void _updatePointerHover(Offset globalPosition) {
        ...
        if (isDayView) {
          if ((_isRTL && localPosition.dx < widget.width - timeLabelWidth) || (!_isRTL && localPosition.dx > timeLabelWidth)) {
            ...
            final AppointmentView? appointment =
                _getAllDayAppointmentOnPoint(_updateCalendarStateDetails.allDayAppointmentViewCollection, localPosition.dx, localPosition.dy);
          ...
          _updateHoveringForViewHeader(
              localPosition, _isRTL ? widget.width - localPosition.dx : localPosition.dx, localPosition.dy, viewHeaderHeight);
          return;
        }
      ...
      if (localPosition.dy > viewHeaderHeight && localPosition.dy < allDayBottom) {
        if ((_isRTL && localPosition.dx < widget.width - timeLabelWidth) || (!_isRTL && localPosition.dx > timeLabelWidth)) {
          ...
          final AppointmentView? appointment = _getAllDayAppointmentOnPoint(
              _updateCalendarStateDetails.allDayAppointmentViewCollection, localPosition.dx, localPosition.dy - viewHeaderHeight);
    ...
    if (hoverDate == null ||
        ...
        (!isMonthView &&
            !CalendarViewHelper.isDateTimeWithInDateTimeRange(widget.calendar.minDate, widget.calendar.maxDate, hoverDate, timeInterval))) {
      if (_hoveringDate != null) {
        _hoveringDate = null;
      }
  ...
  DateTime? _getDateFromPositionForTimeline(double cellWidth, double cellHeight, double x, double y) {
    ...
    if (_isRTL) {
      rowIndex =
          (((_scrollController!.offset % _getSingleViewWidthForTimeLineView(this)) + (_scrollController!.position.viewportDimension - x)) / cellWidth)
              .truncate();
    } else {
    ...
    final double time =
        ((CalendarViewHelper.getTimeInterval(widget.calendar.timeSlotViewSettings) / 60) * rowIndex) + widget.calendar.timeSlotViewSettings.startHour;
    final int hour = time.toInt();
    final int minute = ((time - hour) * 60).round();
    if (columnIndex < 0) {
      columnIndex = 0;
  ...
  void _drawSelection(double x, double y, double timeLabelWidth) {
    ...
    if (selectedDate == null ||
        ...
        (!isMonthView &&
            !CalendarViewHelper.isDateTimeWithInDateTimeRange(widget.calendar.minDate, widget.calendar.maxDate, selectedDate, timeInterval))) {
      return;
    }
...
class _ViewHeaderViewPainter extends CustomPainter {
  ...
  void _addViewHeaderForTimeSlotViews(
    ...
    final bool isDayView = CalendarViewHelper.isDayView(
        view, timeSlotViewSettings.numberOfDaysInView, timeSlotViewSettings.nonWorkingDays, monthViewSettings.numberOfWeeksInView);
    ...
    for (int i = 0; i < visibleDatesLength; i++) {
      ...
      if (!isDayView &&
        ...
        final double weekNumberPosition =
            isRTL ? (size.width - timeLabelWidth) + ((timeLabelWidth - _dateTextPainter.width) / 2) : (timeLabelWidth - _dateTextPainter.width) / 2;
  ...
  void _addMouseHoverForTimeSlotView(
      Canvas canvas, Size size, double xPosition, double yPosition, double dateXPosition, double topPadding, bool isToday, int padding) {
    if (xPosition + dateXPosition <= viewHeaderNotifier.value!.dx &&
      ...
      final Color hoveringColor =
          isToday ? Colors.black.withOpacity(0.12) : (themeData.brightness == Brightness.dark ? Colors.white : Colors.black87).withOpacity(0.04);
      _drawTodayCircle(canvas, xPosition + dateXPosition, yPosition + topPadding + _dayTextPainter.height + padding, _dateTextPainter,
      ...
      case CalendarView.workWeek:
        {
          if (!CalendarViewHelper.isDayView(
                  view, timeSlotViewSettings.numberOfDaysInView, timeSlotViewSettings.nonWorkingDays, monthViewSettings.numberOfWeeksInView) &&
              (dayFormat == 'EEEE' && (locale.contains('en')))) {
            return dayText[0];
          }
          break;
        }
      ...
      case CalendarView.month:
        {
          ...
          if (dayFormat == 'EEEE' && (locale.contains('en'))) {
            return dayText[0];
          }
        }
    }
...
class _SelectionPainter extends CustomPainter {
  ...
  void _drawMonthSelection(Canvas canvas, Size size, double width) {
    ...
    /// [SfCalendar] month not shown leading and trailing dates.
    if (!CalendarViewHelper.isCurrentMonthDate(
        calendar.monthViewSettings.numberOfWeeksInView, calendar.monthViewSettings.showTrailingAndLeadingDates, currentMonth, selectedDate!)) {
      return;
    }
...
class _TimeRulerView extends CustomPainter {
  _TimeRulerView(this.horizontalLinesCount, this.timeIntervalHeight, this.timeSlotViewSettings, this.cellBorderColor, this.isRTL, this.locale,
...
class _CurrentTimeIndicator extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final double currentTimePosition = CalendarViewHelper.getTimeToPosition(
        Duration(hours: getLocationDateTime.hour, minutes: getLocationDateTime.minute), timeSlotViewSettings, minuteHeight);
...
DateTime? _timeFromPosition(DateTime date, TimeSlotViewSettings timeSlotViewSettings, double positionY, _CalendarViewState? currentState,
    double timeIntervalHeight, bool isTimelineView) {
...
class _ResizingAppointmentPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final double scrollOffset =
        view == CalendarView.month || resizingDetails.value.isAllDayPanel ? 0 : resizingDetails.value.scrollPosition ?? scrollController!.offset;
    ...
    if (view != CalendarView.month) {
      ...
      _addSubjectTextForMonthView(canvas, resizingDetails.value.appointmentView!.appointmentRect!, appointmentTextStyle, span,
          isRecurrenceAppointment, xPosition, rect, yPosition);
    }
  ...
  void _addSubjectTextForTimeslotViews(
      Canvas canvas, int textStartPadding, double xPosition, double yPosition, bool isRecurrenceAppointment, Rect rect) {
  ...
  void _addSubjectTextForMonthView(Canvas canvas, RRect appointmentRect, TextStyle style, TextSpan span, bool isRecurrenceAppointment,
      double xPosition, Rect rect, double yPosition) {
    double textSize = -1;
    if (textSize == -1) {
  ...
  void _addRecurrenceIcon(Rect rect, Canvas canvas, int? textPadding, bool isRecurrenceAppointment, double textSize) {
    ...
    if (view == CalendarView.month) {
      ...
      canvas.drawRRect(
          RRect.fromRectAndRadius(Rect.fromLTRB(recurrenceStartPosition, yPosition, recurrenceStartPosition + _textPainter.width, rect.bottom),
      ...
      canvas.drawRRect(
          RRect.fromRectAndRadius(
              Rect.fromLTRB(isRTL ? rect.left + textSize + xPadding : rect.right - textSize - xPadding, rect.bottom - bottomPadding - textSize,
...
class _DraggingAppointmentState extends State<_DraggingAppointmentWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.dragDetails.value.appointmentView != null && widget.calendar.appointmentBuilder != null) {
      final DateTime date = DateTime(_draggingAppointmentView!.appointment!.actualStartTime.year,
          _draggingAppointmentView!.appointment!.actualStartTime.month, _draggingAppointmentView!.appointment!.actualStartTime.day);
      ...
      child = widget.calendar.appointmentBuilder!(
          ...
          CalendarAppointmentDetails(
              ...
              List<dynamic>.unmodifiable(
                  <dynamic>[CalendarViewHelper.getAppointmentDetail(_draggingAppointmentView!.appointment!, widget.calendar.dataSource)]),
              Rect.fromLTWH(
...
class _DraggingAppointmentRenderObjectWidget extends SingleChildRenderObjectWidget {
  ...
  RenderObject createRenderObject(BuildContext context) {
    return _DraggingAppointmentRenderObject(dragDetails, isRTL, textScaleFactor, isMobilePlatform, appointmentTextStyle, dragAndDropSettings,
        calendarView, allDayPanelHeight, viewHeaderHeight, timeLabelWidth, resourceItemHeight, calendarTheme, width, height);
  }
...
class _DraggingAppointmentRenderObject extends RenderBox with RenderObjectWithChildMixin<RenderBox> {
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    if (child == null) {
      ...
      context.paintChild(
          child!,
          Offset(isRTL ? dragDetails.position.value!.dx - dragDetails.appointmentView!.appointmentRect!.width : dragDetails.position.value!.dx,
  ...
  void _drawDefaultUI(Canvas canvas, bool isTimelineView) {
    ...
    final RRect rect = RRect.fromRectAndRadius(
        Rect.fromLTWH(
            ...
            dragDetails.position.value!.dy,
            isRTL ? -dragDetails.appointmentView!.appointmentRect!.width : dragDetails.appointmentView!.appointmentRect!.width,
